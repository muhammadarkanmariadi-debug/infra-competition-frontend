...
const Sambutan = () => {
  return (
    <>
    <section id="sambutan" className='relative bg-gradient-to-br from-secondary via-secondary to-primary/20 py-20 overflow-hidden'>
        ...
        <div className='items-center gap-12 grid lg:grid-cols-2'>
            ...
            <div className='relative'>
              ...
              >
                ...
                >
                  ...
                  <p className='text-white/90 text-lg'>Kepala Sekolah</p>
                </motion.div>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Quote className='w-16 h-16 text-white/40' />
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className='font-medium text-white/95 text-xl leading-relaxed'>
            ...
            >
              ...
              <div className='text-right'>
                <p className='font-bold text-white text-lg'>Rahmat Dwi Djatmiko, S.Kom</p>
                <p className='text-white/80'>Kepala Sekolah</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
