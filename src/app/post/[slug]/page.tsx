    ...
    <>
      ...
      >
        <div className='w-[60%] max-lg:w-full'>
          <div className='flex flex-col gap-4 pt-20 pb-[24px]'>
            <h1 className='w-[90%] font-[600] text-[27px] text-black leading-[150%]'>
              {data?.title}
            </h1>
            <div className='flex justify-between'>
              <div className='flex items-center gap-4'>
                <div className='rounded-circle w-[28px] h-[28px]'>
                  <img
          ...
          <div className=''>
           <Image src={`http://localhost:8000/storage/${data?.thumbnail}`} width={800} height={200} alt="Related News" className='rounded-xl' />
          </div>
          ...
          <div className='pt-8 leading-6 prose'>
            <p className='font-[400] text-[18px] text-black'>{data?.body}</p>
          </div>
        </div>
        <div className='w-[40%] max-lg:w-full'>
          <div className='flex flex-col gap-4 pt-20 pb-[24px]'>
            <h1 className='font-[600] text-[27px] text-black leading-[150%]'>
              Berita Terkait
            </h1>
            <div>
              <img
              ...
              <div className='flex flex-wrap justify-between items-center mt-[15px]'>
                <div className='w-[50%]'>
                  <h1 className='font-[600] text-[23px] text-black leading-[150%]'>
                    <a
                      href='/'
            ...
            <div className='flex justify-between items-center mt-4'>
              ...
              <div className='flex items-center gap-3'>
                ...
                <p className='font-[500] text-[14px] text-black hover:text-primary transition-colors duration-300'>
                  <a href='/'>Iqbal Setengah Matang</a>
                </p>
              </div>

              {/* Kanan: tanggal */}
              <p className='font-[500] text-[14px] text-black'>20 Jan 2024</p>
            </div>
          </div>
        </div>
      </div>
