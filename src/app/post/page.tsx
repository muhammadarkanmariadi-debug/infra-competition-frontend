      ...
      >
        <div className="w-[60%]">
          <div className="pt-20 pb-[24px] gap-4 flex flex-col">
            <h1 className="text-[27px] w-[90%] leading-[150%] text-black font-[600]">
          ...
          <div className="prose leading-6 pt-8">
            ...
            <p className="mt-5">
              🗓️ <strong>Pra-MPLS</strong> – Warming Up the Hive Kegiatan
              dimulai dengan check-in, apel pembukaan, pengenalan kakak gugus
              (Kagus), serta pembentukan yel-yel khas tiap gugus. Para peserta
              juga mulai mengerjakan tugas pengenalan dan membuat konten kreatif
              untuk menunjukkan semangat awal mereka. Di sinilah benih
              kekompakan mulai tumbuh.
            </p>
            <br />
            <p>
              <strong className="mt-5">
                🗓️ Day 1 – First Flight into the Hive
              </strong>
            </p>
            <p>
            ...
            <a href="tes.html">
              <div>
                ...
                <div className="flex flex-wrap items-center justify-between mt-[15px]">
                  <div className="w-[50%]">
                    <h1 className="text-[23px] leading-[150%] text-black font-[600]">
                      <a
                        href="/"
