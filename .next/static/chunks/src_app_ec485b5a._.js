        ...
        "BeritaPage.useEffect": ()=>{
            const fetchPosts = {
                "BeritaPage.useEffect.fetchPosts": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get('/blog');
...
_s(BeritaPage, "eewkBkcuz081w6xcKE95rhnyecw=", false, function() {
    return [
...
//# sourceMappingURL=src_app_ec485b5a._.js.map