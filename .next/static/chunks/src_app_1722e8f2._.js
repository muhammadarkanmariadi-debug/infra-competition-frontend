...
"[project]/src/app/admin/posts/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditPostForm() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditPostForm.useEffect": ()=>{
            const fetchPost = {
                "EditPostForm.useEffect.fetchPost": async ()=>{
                    try {
                        setFetching(true);
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(`/blog/${postId}`);
                        const post = response.data.data;
                        setFormData({
                            title: post.title || "",
                            short_body: post.short_body || "",
                            slug: post.slug || "",
                            tags: post.tags ? post.tags.split(",").map({
                                "EditPostForm.useEffect.fetchPost": (tag)=>tag.trim()
                            }["EditPostForm.useEffect.fetchPost"]) : [],
                            body: post.body || "",
                            thumbnail: null,
    ...
    const handleSubmit = async (e, publishStatus = "draft")=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/blog/${postId}`, JSON.stringify(payload));
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    !formData.thumbnail && formData.existingThumbnail && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "mt-2 text-gray-500 text-sm",
...
_s(EditPostForm, "QiMYa9Q4siMwytGuIJNptjTip/k=", false, function() {
    return [
...
//# sourceMappingURL=src_app_1722e8f2._.js.map