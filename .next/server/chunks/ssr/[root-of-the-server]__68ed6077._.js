...
function LoginForm() {
    ...
    const handleCredentialLogin = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/login', {
            ...
            if (response.status === 200 && data.token) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setAuthToken"])(data.token);
                router.push('/admin');
            } else {
    ...
    const handleGoogleLogin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$oauth$2f$google$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGoogleLogin"])({
        onSuccess: async (tokenResponse)=>{
            setIsLoading(true);
            try {
                // Send Google access token to Laravel backend
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/login/google/callback', {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__68ed6077._.js.map